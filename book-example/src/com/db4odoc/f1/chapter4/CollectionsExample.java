...
public class CollectionsExample extends Util {
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println("storeFirstCar:");
			storeFirstCar(db);
			System.out.println("storeSecondCar");
			storeSecondCar(db);
			System.out.println("retrieveAllSensorReadout");
			retrieveAllSensorReadout(db);
			System.out.println("retrieveSensorReadoutQBE");
			retrieveSensorReadoutQBE(db);
			System.out.println("retrieveCarQBE");
			retrieveCarQBE(db);
			System.out.println("retrieveCollections");
			retrieveCollections(db);
			System.out.println("retrieveArrays");
			retrieveArrays(db);
			System.out.println("retrieveAllSensorReadoutNative");
			retrieveAllSensorReadoutNative(db);
			System.out.println("retrieveSensorReadoutNative");
			retrieveSensorReadoutNative(db);
			System.out.println("retrieveCarNative");
			retrieveCarNative(db);
			System.out.println("retrieveSensorReadoutQuery");
			retrieveSensorReadoutQuery(db);
			System.out.println("retrieveCarQuery");
			retrieveCarQuery(db);
			db.close();
